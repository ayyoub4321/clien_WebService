 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://webService.ayyoub.net/", wsdlLocation = "http://localhost:9090/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://webService.ayyoub.net/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://webService.ayyoub.net/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.ayyoub.net/", "BanqueServicePort"), BanqueService.class, features);
    }
