...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDH_QNAME = new QName("http://webService.ayyoub.net/", "ConversionEuroToDH");
    private static final QName _ConversionEuroToDHResponse_QNAME = new QName("http://webService.ayyoub.net/", "ConversionEuroToDHResponse");
    private static final QName _GetCompte_QNAME = new QName("http://webService.ayyoub.net/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://webService.ayyoub.net/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://webService.ayyoub.net/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://webService.ayyoub.net/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://webService.ayyoub.net/", name = "ConversionEuroToDH")
     ...
     */
    @XmlElementDecl(namespace = "http://webService.ayyoub.net/", name = "ConversionEuroToDHResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://webService.ayyoub.net/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://webService.ayyoub.net/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://webService.ayyoub.net/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://webService.ayyoub.net/", name = "listComptesResponse")
